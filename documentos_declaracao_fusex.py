...
class Application:
    def __init__(self, master=None):
        ...
        self.widget1.pack()
        self.msg = Label(self.widget1, text="Declaração FUSEX SD Evs - Selecione alguma ação abaixo:")
        ...
        self.abrir_odtDESPACHO["text"] = "Modelo DECLARAÇÃO"
    ...
    def pdfs_prontos_thread(self):
        ...
        explore(prontosURL)
    def open_csv(self):
        listaURL = os.path.join(rootDirURL, "declaracao_fusex", "lista.csv")
    ...
    def run(self):
        ...
        configure.setzipSourceFile("declaracao_fusex","modelo.odt")
        # definimos o arquivo lista
        configure.setcsvSourceFile("declaracao_fusex","lista.csv")
...
root = Tk()
Application(root)
root.title('Declaração dos SDs Evs')
